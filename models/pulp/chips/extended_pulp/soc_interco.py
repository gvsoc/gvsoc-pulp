...
class Soc_interco(st.Component):
    ...
    def __init__(self, parent, name, soc, cluster):
        ...
        ll_ico.add_mapping('axi_master'    , base=cluster.get_property('mapping/base'), size=hex((cluster.get_property('mapping/size', int)*soc.get_property('nb_cluster'))))
        ...
        fc_data_ico.add_mapping('axi_proxy', base=0x90000000, size=0x0A000000)
