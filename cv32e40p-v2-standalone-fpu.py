...
# CV32E40P iss_v2 co-simulation target, FPU configuration (rv32imfc + CoreV).
...
class Target(gvsoc.runner.Target):
    ...
    description = "CV32E40P iss_v2 standalone for UVM co-simulation (FPU)"
    model = Cv32e40p
    name = "cv32e40p-v2-standalone-fpu"
