...
import pulp.chips.pulp_multicluster.soc_interco as soc_interco
import pulp.chips.pulp_multicluster.apb_soc_ctrl as apb_soc_ctrl
...
from pulp.chips.pulp_multicluster.cluster import get_cluster_name
from vp.clock_domain import Clock_domain
from pulp.chips.pulp_multicluster.udma import Udma
...
class Soc(st.Component):
    ...
    def __init__(self, parent, name, parser, config_file, chip, cluster):
        ...
        # FC
        fc = iss.FcCore(self, 'fc', cluster_id=512)
        ...
        axi_ico.add_mapping('axi_proxy', base=0x90000000, size=0x0A000000)
        ...
        for cid in range(0, nb_cluster):
            axi_ico.add_mapping(get_cluster_name(cid), base=hex(base + size*cid), size=size)
