...
from pulp.chips.pulp_multicluster.soc import Soc
from pulp.chips.pulp_multicluster.cluster import Cluster, get_cluster_name
...
class Pulp_open(st.Component):
    ...
    def __init__(self, parent, name, parser, soc_config_file='pulp/chips/pulp_multicluster/soc.json',
            cluster_config_file='pulp/chips/pulp_multicluster/cluster.json', padframe_config_file='pulp/chips/pulp_multicluster/padframe.json',
            use_ddr=False):
        ...
        nb_cluster = self.add_property('nb_cluster', 2)
