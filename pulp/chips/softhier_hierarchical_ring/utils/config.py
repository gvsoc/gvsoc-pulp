...
parser.add_argument("input_file", nargs="?", default="pulp/pulp/chips/softhier_hierarchical_ring/softhier_arch.py", help="Path to the input Python file")
args = parser.parse_args()
input_file = args.input_file

# Read the input Python file
C_header_file = 'pulp/pulp/chips/softhier_hierarchical_ring/sw/runtime/include/softhier_arch.h'
S_header_file = 'pulp/pulp/chips/softhier_hierarchical_ring/sw/runtime/include/softhier_arch.inc'
