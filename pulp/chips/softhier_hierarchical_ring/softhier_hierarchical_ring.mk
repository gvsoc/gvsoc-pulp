...
sh-ring-hw:
	make sh-ring-config
	make TARGETS=pulp.chips.softhier_ring.softhier_ring_target all
...
sh-ring-run:
	./install/bin/gvsoc --target=pulp.chips.softhier_ring.softhier_ring_target --binary sw_build/softhier.elf run
