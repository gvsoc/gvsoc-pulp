...
from pulp.chips.chimera.soc import Soc
from pulp.chips.chimera.cluster import Cluster, get_cluster_name
...
class Pulp_open(st.Component):
    ...
    def __init__(self, parent, name, parser, soc_config_file='pulp/chips/chimera/soc.json',
            cluster_config_file='pulp/chips/chimera/cluster.json', padframe_config_file='pulp/chips/chimera/padframe.json',
            use_ddr=False):
