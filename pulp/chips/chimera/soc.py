...
import pulp.chips.chimera.soc_interco as soc_interco
...
from pulp.chips.chimera.cluster import get_cluster_name
from vp.clock_domain import Clock_domain
from pulp.chips.chimera.udma import Udma
...
class Soc(st.Component):
    ...
    def __init__(self, parent, name, parser, config_file, chip, cluster):
        ...
        udma_conf_path = 'pulp/chips/chimera/udma.json'
