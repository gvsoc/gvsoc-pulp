...
config_file_torus ?= "pulp/pulp/chips/softhier_torus/softhier_arch.py"
ifdef cfg
	config_file_torus = "$(cfg)"
endif

sh-torus-config:
	@if [ "$(config_file_torus)" != "pulp/pulp/chips/softhier_torus/softhier_arch.py" ]; then \
		cp -f $(config_file_torus) pulp/pulp/chips/softhier_torus/softhier_arch.py; \
	fi
	python3 pulp/pulp/chips/softhier_torus/utils/config.py $(config_file_torus)

sh-torus-hw:
	make sh-torus-config
