...
ACTUAL_TOPO ?= softhier_hierarchical_ring
...
sh-config:
	...
	python3 pulp/pulp/chips/softhier/common/utils/config.py $(config_file_hierarchical_ring) pulp/pulp/chips/softhier/common/sw/runtime/include
