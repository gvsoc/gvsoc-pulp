...
sh-config:
	...
	python3 pulp/pulp/chips/softhier/softhier_fht/utils/config.py $(config_file_fht)

sh-hw:
	make sh-config
	make TARGETS=pulp.chips.softhier.softhier_fht.softhier_target all
...
sh-sw:
	...
	cd sw_build && $(CMAKE) $(sw_cmake_arg) $(arch_cmake_arg) ../pulp/pulp/chips/softhier/softhier_fht/sw/ && make
...
sh-run:
	./install/bin/gvsoc --target=pulp.chips.softhier.softhier_fht.softhier_target --binary sw_build/softhier.elf run