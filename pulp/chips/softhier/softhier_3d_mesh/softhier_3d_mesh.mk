...
sh-config:
	python3 pulp/pulp/chips/softhier/topologies/gen_floogen_topology.py 3d_mesh \
		pulp/pulp/chips/softhier/topologies/generated $(PARAM_FLAGS)
	python3 pulp/pulp/chips/softhier/common/utils/config.py 3d_mesh \
