...
from pulp.chips.softhier.softhier_arch_base import SoftHierArchFoldedHexaTorus as SoftHierArch, get_arch_overrides
...
class SoftHierSystem(gvsoc.systree.Component):
    ...
    def __init__(self, parent, name, parser):
        ...
        floogen_path = os.path.join(topologies_dir, 'folded_hexatorus.floogen.yml')
        routing_path = os.path.join(topologies_dir, 'folded_hexatorus.routing.yml')
        link_latencies_path = os.path.join(topologies_dir, 'folded_hexatorus.link_latencies.yml')
