    ...
    : vp::Component(config)
{
    ...
    this->hbm_preload_done_itf.set_sync_meth(&SoftHierCtrl::hbm_preload_done_handler);
    ...
    this->debug_stop_event = this->event_new(&SoftHierCtrl::debug_stop_event_handler);
    this->hbm_preload_done_to_cluster_event = this->event_new(&SoftHierCtrl::hbm_preload_done_to_cluster_handler);
    this->timer_start = 0;
...
void SoftHierCtrl::debug_stop_event_handler(vp::Block *__this, vp::ClockEvent *event){
...
void SoftHierCtrl::hbm_preload_done_to_cluster_handler(vp::Block *__this, vp::ClockEvent *event){
    SoftHierCtrl *_this = (SoftHierCtrl *)__this;
...
void SoftHierCtrl::hbm_preload_done_handler(vp::Block *__this, bool value)
{
    SoftHierCtrl *_this = (SoftHierCtrl *)__this;
