...
class Pulp_open(st.Component):
    ...
    def __init__(self, parent, name, parser, soc_config_file='pulp/chips/siracusa/soc.json',
            cluster_config_file='pulp/chips/siracusa/cluster.json', padframe_config_file='pulp/chips/siracusa/padframe.json',
            use_ddr=False):
