...
from pulp.chips.soft_hier_old.snitch.hierarchical_cache import Hierarchical_cache
from vp.clock_domain import Clock_domain
import pulp.chips.soft_hier_old.snitch.l1_subsystem as l1_subsystem
import interco.router as router
import utils.loader.loader
import gvsoc.systree as st
from pulp.chips.soft_hier_old.snitch.snitch_cluster.cluster_registers import ClusterRegisters
...
class Soc(st.Component):
    ...
    def __init__(self, parent, name, parser):
        ...
        rom = memory.Memory(self, 'rom', size=0x10000, width_log2=3, stim_file=self.get_file_path('pulp/chips/soft_hier_old/snitch/bootrom.bin'))
