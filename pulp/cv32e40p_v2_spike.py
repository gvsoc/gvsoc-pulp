...
# CV32E40P iss_v2 bring-up platform, shared by the cv32e40p-v2-spike*
# targets (one target name per core configuration, so each gets its own
# serialized platform tree).
#
...
class Cv32e40pSpikeTop(gvsoc.systree.Component):
    ...
    def __init__(self, parent, name=None, fpu: int=0, zfinx: int=0):
        ...
        config = Cv32e40pSpikeConfig('soc', fpu=fpu, zfinx=zfinx)
