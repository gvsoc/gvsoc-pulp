 ...
 */
class IDmaMeSplit : public vp::Block, public IdmaTransferConsumer, public IdmaTransferProducer
{
public:
    /**
     ...
     */
    IDmaMeSplit(vp::Component *idma, IdmaTransferProducer *fe, IdmaTransferConsumer *be, int dma_split_size);
    ...
    void set_be(IdmaTransferConsumer *be) { this->be = be; }
...
private:
    ...
    int dma_region_end;
    // Queue of splitted transfers that are pending ack.
