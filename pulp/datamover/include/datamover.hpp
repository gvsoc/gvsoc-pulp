...
class Datamover : public vp::Component
{
    ...
    private:
        ...
        // CONFIGURATION PARAMETERS unpacked
        int32_t  in_d0_stride;
        uint32_t in_d0_len;
        int32_t  in_d1_stride;
        uint32_t in_d1_len;
        int32_t  in_d2_stride;
        uint32_t in_d2_len;
        int32_t  in_d3_stride;
        uint32_t in_d3_len;
        int32_t  in_d4_stride;
        uint32_t in_dim_enable;
        int32_t  out_d0_stride;
        uint32_t out_d0_len;
        int32_t  out_d1_stride;
        uint32_t out_d1_len;
        int32_t  out_d2_stride;
        uint32_t out_d2_len;
        int32_t  out_d3_stride;
        uint32_t out_d3_len;
        int32_t  out_d4_stride;
