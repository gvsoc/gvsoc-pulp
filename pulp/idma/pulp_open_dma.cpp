 ...
 *   - AXI and TCDM backend protocols, for the external interconnect and the local TCDM. The TCDM
 *     port is as wide as the datapath dmac_wrap feeds to mem_to_banks; the split over the banks is
 *     done by the DMA interleaver of the L1 subsystem.
 *
