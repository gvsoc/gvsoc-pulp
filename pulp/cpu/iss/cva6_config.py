...
class Cva6Config(RiscvConfig):
    isa: str = cfg_field(default='rv64imafdcv', dump=True, desc=(
    ...
    pmp: bool = cfg_field(default=True, dump=True, desc=(
        "True if the ISS should include the PMP."
    ))
    mmu: bool = cfg_field(default=True, dump=True, desc=(
