...
public:
    ...
    static constexpr int REQ_SRC_TILE = 2;
    static constexpr int REQ_SRC_X = 3;
    static constexpr int REQ_SRC_Y = 4;
    static constexpr int REQ_DEST_X = 5;      // X coordinate of the destination target
    static constexpr int REQ_DEST_Y = 6;      // Y coordinate of the destination target
    static constexpr int REQ_NI = 7;      // When a request is stalled, this gives the network interface where to grant it
