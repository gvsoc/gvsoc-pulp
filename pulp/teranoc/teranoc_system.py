...
class TeranocSystem(st.Component):
    ...
    def __init__(self, parent, name, parser, options):
        ...
        soc = System(self, 'teranoc_soc', parser, terapool=True, nb_cores_per_tile=4, nb_x_groups=4, nb_y_groups=4, total_cores=1024, nb_remote_ports_per_tile=2, bank_factor=4, axi_data_width=64)
...
class MinpoolNocSystem(st.Component):
    ...
    def __init__(self, parent, name, parser, options):
        ...
        soc = System(self, 'minpool_noc_soc', parser, terapool=False, nb_cores_per_tile=4, nb_x_groups=2, nb_y_groups=2, total_cores=16, nb_remote_ports_per_tile=2, bank_factor=4, axi_data_width=32)
