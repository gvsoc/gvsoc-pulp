...
class L1_subsystem(gvsoc.systree.Component):
    ...
    def __init__(self, parent: gvsoc.systree.Component, name: str, tile_id: int=0, group_id: int=0,
        ...
        for i in range(0, nb_pe):
            remote_local_output_selectors.append(MempoolXbarSelector(self, f'remote_local_output_selector_core{i}', output_id=0))
        remote_group_output_selectors = []
        for i in range(0, nb_pe):
            remote_group_output_selectors.append(MempoolXbarSelector(self, f'remote_group_output_selector_core{i}', output_id=i % nb_remote_group_masters + 1))
