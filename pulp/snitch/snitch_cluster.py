...
# from pulp.snitch.snitch_cluster_submodule.cluster_registers import ClusterRegisters
...
class Soc(st.Component):
    ...
    def __init__(self, parent, name, parser):
        ...
        for core_id in range(0, nb_cores):
            # int_cores.append(iss.Snitch(self, f'pe{core_id}', isa=args.isa, fetch_enable=True, 
            #                             boot_addr=0x01000000, core_id=core_id))
            # fp_cores.append(iss.Snitch_fp_ss(self, f'pe{core_id}', isa=args.isa, fetch_enable=True, 
            #                             boot_addr=0x01000000, core_id=core_id))
