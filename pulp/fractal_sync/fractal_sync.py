...
#we have 2 master ports
    def o_MASTER_N(self, itf: gvsoc.systree.SlaveItf):
        self.itf_bind('master_n_output_port', itf, signature='wire<MstPortOutput<uint32_t>*>')

    def i_MASTER_N(self) -> gvsoc.systree.SlaveItf:
        return gvsoc.systree.SlaveItf(self, 'master_n_input_port', signature='wire<MstPortInput<uint32_t>*>')
...
#we have 4 slave ports
    ...
    def i_SLAVE_EAST(self) -> gvsoc.systree.SlaveItf:
        return gvsoc.systree.SlaveItf(self, 'slave_e_input_port', signature='wire<SlvPortInput<uint32_t>*>')

    def o_SLAVE_EAST(self, itf: gvsoc.systree.SlaveItf):
        self.itf_bind('slave_e_output_port', itf, signature='wire<SlvPortOutput<uint32_t>*>')

    def i_SLAVE_WEST(self) -> gvsoc.systree.SlaveItf:
        return gvsoc.systree.SlaveItf(self, 'slave_w_input_port', signature='wire<SlvPortInput<uint32_t>*>')

    def o_SLAVE_WEST(self, itf: gvsoc.systree.SlaveItf):
        self.itf_bind('slave_w_output_port', itf, signature='wire<SlvPortOutput<uint32_t>*>')
